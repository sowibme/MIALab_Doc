...
\caption{Regions involved to calculate the DSC. $S$ is the set of segmented pixels and therefore the output of the segmentation pipeline. $G$ is the set of pixels of the ground truth data.$S$, $G$ and the intersection between the two sets is used to calculate the DSC value.}
\label{fig:dice}
\end{figure}
